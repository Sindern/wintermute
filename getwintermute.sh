...
wget http://voximp.googlecode.com/files/pocketsphinx-0.5-1-i686.pkg.tar.gz
...
if [[ "$(uname -m)" == "x86_64" ]]
then 
  wget http://ubuntu.wallawalla.edu/ubuntu//pool/universe/s/sphinxbase/libsphinxbase1_0.4.1-0ubuntu1_amd64.deb
  wget http://mirrors.us.kernel.org/ubuntu//pool/universe/p/pocketsphinx/libpocketsphinx1_0.5.1+dfsg1-0ubuntu2_amd64.deb
  wget http://security.ubuntu.com/ubuntu/pool/universe/p/pocketsphinx/gstreamer0.10-pocketsphinx_0.5.1+dfsg1-0ubuntu3_amd64.deb
  ...
  wget http://mirror.pnl.gov/ubuntu//pool/universe/s/sphinxbase/libsphinxbase1_0.4.1-0ubuntu1_i386.deb
  sudo dpkg -i libsphinxbase1_0.4.1-0ubuntu1_i386.deb
  wget http://mirror.pnl.gov/ubuntu//pool/universe/p/pocketsphinx/libpocketsphinx1_0.5.1+dfsg1-0ubuntu3_i386.deb
  sudo dpkg -i libpocketsphinx1_0.5.1+dfsg1-0ubuntu3_i386.deb
  wget http://mirror.pnl.gov/ubuntu//pool/universe/p/pocketsphinx/gstreamer0.10-pocketsphinx_0.5.1+dfsg1-0ubuntu1_i386.deb
